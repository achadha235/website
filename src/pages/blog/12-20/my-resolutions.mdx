...
export const meta = {
  ...
  banner: `A reflection on the year gone by and goalsetting for the one ahead. With planning, consistent hard work and a little luck, 2021 will be the time to unlock new doors and opportunities for growth`,
  categories: ['Fun', 'Life'],
};
