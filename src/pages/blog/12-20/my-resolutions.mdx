...
As the new year is about to start, I decided to set some new resolutions for
myself. The objective of this post is to serve as a written record of my goals
so that I can create some accountability.
