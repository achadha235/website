...
export const metadata = {
  ...
  hidden: false,
  publishedAt: DateTime.fromISO("2021-01-01"),
...
<div className="box bg-base-100 p-4 rounded-box">
# Attainable Resolutions for the Year Ahead
<ArticleTags tags={metadata.categories}/>
<br/>
<div className="text-lg">Published {metadata.publishedAt.toRelativeCalendar()} </div> 
<div className="text-sm font-light">on {metadata.publishedAt.toLocaleString(DateTime.DATETIME_MED)}</div>
</div>
